...
integer :: j,k,i, code
real,dimension(xsize(1),xsize(2),xsize(3)) :: ux,uy,uz,phi
real :: udx,udy,udz,uddx,uddy,uddz,uxmax,&
...
enddo
enddo
call MPI_ALLREDUCE(uxmax,uxmax1,1,MPI_REAL,MPI_MAX,MPI_COMM_WORLD,code)
call MPI_ALLREDUCE(uxmin,uxmin1,1,MPI_REAL,MPI_MIN,MPI_COMM_WORLD,code)
