c   ********************* subr rearuu
c  this subroutine read the velocity correlations   
c  evaluated in a previous run
c  to follow the averaging in time
c
...
c
c   ********************* subr ruphkp
c  this subroutine perform the calculation of the correlations
c   by using the FFT in x1 and x3
c
   ...
   12 continue
c
c   2-d real  fft applied to the each velocity component  
...
c
c   spanwise correlation     in  physical space
c  real fft from wave number to physical space
c
