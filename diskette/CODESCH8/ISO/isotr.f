c
c   there are three of these solvers for the reason that two dimensional
c   arrays are used for the coefficients of the matrices
c   Minor programming work could reduce the storage
c
c  ****************************** subrout trvpjk  **********************
c  tridiagonal solver with periodic conditions
c  the storage for the triadiagonal matrices is redundant, 
c  in fact the coefficients should be constant 
c
