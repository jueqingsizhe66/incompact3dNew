...
c
      common/bugme/budg(4,6,m2)
      common/bugmo/budgo(4,6,m2)
      ...
      common/iavg/iav
      common/skfl/ske(4,m2),fla(4,m2),pvc(4,m2),vtv(4,m2)
      common/skflo/skeo(4,m2),flao(4,m2),pvmo(4,m2),vtvo(4,m2)
      common/tauwal/cfnp
      common/vomean/vorv(3,m2),vorstr(6,m2),vdtomt(3,m2),vcromt(6,m2)
      common/vomeao/voro(3,m2),vorsto(6,m2),vdtomo(3,m2),vcromo(6,m2)
      common/diss/dissj(m2),stmed(9,m2),enspr(m2),ensy(m2)
      common/disso/dissjo(m2),stmedo(9,m2),enspo(m2),ensyo(m2)
      common/presgr/dp3ns
c
c     dt variabile
c
