...
c  the reduced wave numbers 
c  And initiates the FFT routines taken by the
c  ESSL IBM libraries
c
...
c
   ...
   28 continue
c
c   initiation of the FFT routines
c
      iftin=1
...
c   are calculated this subr. The routine is called only at the beginning
c
